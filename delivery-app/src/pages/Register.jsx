  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>🚗 Crear cuenta de repartidor</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button style={styles.button} type="submit">Registrarse como Repartidor</button>
        </form>
...
const styles = {
  ...
  button: { width: '100%', padding: '0.75rem', background: '#1565C0', color: 'white', border: 'none', borderRadius: '8px', fontSize: '1rem', cursor: 'pointer' },
