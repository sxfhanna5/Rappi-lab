  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role !== 'consumer') {
        setError('Esta app es solo para consumidores')
        return
      }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>🛒 Consumer App</h2>
...
const styles = {
  ...
  button: { width: '100%', padding: '0.75rem', background: '#FF6B35', color: 'white', border: 'none', borderRadius: '8px', fontSize: '1rem', cursor: 'pointer' },
